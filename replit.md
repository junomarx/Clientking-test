...
- July 18, 2025: E-MAIL-PROBLEM DIAGNOSTIZIERT UND BEHOBEN - Problem identifiziert: Nach Entfernung von Brevo/SendGrid müssen Benutzer SMTP-Einstellungen konfigurieren, umfassende Anleitung erstellt (SMTP-KONFIGURATION-ANLEITUNG.md), verbesserte Fehlermeldungen in PrintButtons und PrintRepairA4Dialog implementiert, Diagnose-Tool test-email-functionality.js erstellt - Alle E-Mail-Funktionen (Kostenvoranschläge, A4-Reparaturaufträge) funktionieren nach SMTP-Konfiguration vollständig
