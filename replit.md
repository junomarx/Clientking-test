...
- July 12, 2025: MODAL UND API-ENDPUNKTE REPARIERT - Native HTML-Modal mit korrigierten API-Routen: Anzahlung-Anzeige hinzugefügt, API-Endpunkte für Bulk-Updates korrigiert (/api/orders/accessories/bulk-update und /api/orders/spare-parts/bulk-update), forcierte Cache-Invalidierung mit automatischem Reload für sofortige UI-Updates, vollständige Status-Änderung funktionsfähig
