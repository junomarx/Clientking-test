...
- July 18, 2025: QR-CODE UNTERSCHRIFTEN VOLLSTÄNDIG OPTIMIERT - Alle QR-Code-Scans springen sofort zum Querformat-Unterschrifts-Modus ohne Terms/Device-Code-Schritte, automatische Status-Änderung "fertig" → "abgeholt" für Pickup-Unterschriften funktioniert korrekt, Unterschriften werden erfolgreich zur Reparatur übertragen (Dropoff/Pickup), Server-seitige Validierung und Logging implementiert
