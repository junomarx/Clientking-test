-- Skript zur Korrektur duplizierter Shop-IDs (überarbeitete Version)
-- Dieses SQL-Skript:
...
-- 1. Zuerst identifizieren wir die duplizierten Shop-IDs
...
-- Benutzer mit duplizierten Shop-IDs ausgeben
SELECT id, username, email, shop_id 
FROM users 
WHERE shop_id = 1
ORDER BY id;

-- 3. Überprüfen, ob noch Duplikate existieren
DO $$
DECLARE
