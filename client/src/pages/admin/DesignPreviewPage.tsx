...
import { Search, Filter, ArrowDownWideNarrow, Settings } from 'lucide-react';
...
// Dummy-Daten für den Fall, dass die API-Abfrage fehlschlägt
const fallbackData: any[] = []; // Leeres Array, keine synthetischen Daten
...
export default function DesignPreviewPage() {
  ...
  return (
    <div className="flex h-screen bg-blue-600 p-6 text-white">
      {/* Seitenleiste */}
      <div className="w-64 bg-white rounded-l-lg p-6 mr-4 text-gray-800">
        <div className="mb-8">
          <h2 className="text-xl font-bold mb-4">YOURLOGO</h2>
        </div>
        
        <nav className="space-y-4">
          <div className="flex items-center p-2 rounded-md hover:bg-gray-100 text-blue-600 font-medium">
      ...
      {/* Hauptbereich */}
      <div className="flex-1 bg-white rounded-r-lg text-gray-800">
        {/* Header */}
        ...
        {/* Content */}
        <div className="p-6">
          <h2 className="text-2xl font-semibold text-blue-600 mb-6">Reparaturen und Kunden</h2>
