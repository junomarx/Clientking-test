 ...
 */
export const CostEstimateFixedPrint: React.FC<PrintButtonsProps> = ({ 
  estimate, 
  items, 
  customer 
}) => {
  ...
  // Drucken-Button Handler mit korrigierten Kundeninformationen (kein Telefon/E-Mail)
  // und angezeigtem Firmenlogo
  const handlePrint = () => {
  ...
  const handlePdfExport = () => {
    ...
    // Wir verwenden die gleiche Funktion wie oben, aber ohne automatisches Drucken
    handlePrint();
  };
