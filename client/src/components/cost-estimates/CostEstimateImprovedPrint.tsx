...
interface PrintCostEstimateProps {
  estimate: any;
  items: any[];
  customer: any | null;
}
...
/**
 * Verbesserte Komponente zum Drucken von Kostenvoranschlägen
 * Implementiert den Druckprozess mit überarbeitetem Design und verbesserter Darstellung
 */
export function CostEstimateImprovedPrint({ estimate, items, customer }: PrintCostEstimateProps) {
  ...
  const generatePrintContent = useCallback(() => {
    ...
    `;
  }, [estimate, items, customer, businessSettings]);
  ...
  }, [openPrintWindow, generatePrintContent]);

  /**
   * Öffnet ein Fenster zum Exportieren als PDF
   */
  ...
  }, [openPrintWindow, generatePrintContent, toast]);

  /**
   * Component gibt Druckfunktionen zurück
   */
  return {
