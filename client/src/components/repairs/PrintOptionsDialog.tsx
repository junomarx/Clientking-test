...
export function PrintOptionsDialog({
  ...
  const handlePrint = () => {
    ...
    if (selectedPrintOption === 'thermal') {
      ...
      // Etiketteninhalt mit fest eingebettetem QR-Code
      // Statt einen dynamischen QR-Code-Generator zu nutzen, verwenden wir ein Base64-Bild
      const repairDetailsUrl = `${window.location.origin}/repairs/${repair?.id}`;
      
      // Einfaches, statisches HTML für das Etikett mit eingebettetem Base64-QR-Code
      printContents = `
        <div style="width: 32mm; margin: 0 auto; padding: 3mm;">
          <div style="text-align: center; font-size: 16px; font-weight: bold; margin-bottom: 2mm;">
          ...
          <div style="text-align: center; margin-bottom: 2mm;">
            <img src="data:image/png;base64," 
                 alt="QR-Code" style="width:20mm; height:20mm;">
          </div>
          
          <div style="text-align: center; margin-bottom: 2mm;">
            <div style="font-size: 11px; font-weight: bold;">${customer?.firstName || ''}</div>
            <div style="font-size: 11px; font-weight: bold;">${customer?.lastName || ''}</div>
            <div style="font-size: 10px;">${customer?.phone || ''}</div>
          </div>
          
          <div style="text-align: center;">
            <div style="font-size: 11px; font-weight: bold;">${repair?.model || ''}</div>
            <div style="font-size: 9px; white-space: pre-wrap; text-align: left;">${repair?.issue ? repair.issue.split(',').join('\n') : ''}</div>
          </div>
        </div>
      `;
